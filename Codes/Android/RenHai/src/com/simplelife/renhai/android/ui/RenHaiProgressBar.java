...
public class RenHaiProgressBar extends LinearLayout {
	...
	public RenHaiProgressBar(Context context) {
		super(context);
		this.context = context;
		init();
	}
	
	public RenHaiProgressBar(Context context, AttributeSet attrs) {
    	super(context, attrs);
    	this.context = context;
    	init();
	}
