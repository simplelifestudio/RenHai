 ...
 * HotInterestLabelStatistics entities. Transaction control of the save(),
...
public class HotInterestLabelStatisticsDAO extends BaseHibernateDAO {
	...
	public HotInterestLabelStatistics findById(java.lang.Integer id) {
		...
		try {
			HotInterestLabelStatistics instance = (HotInterestLabelStatistics) getSession()
					.get("com.simplelife.renhai.server.db.HotInterestLabelStatistics",
							id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<HotInterestLabelStatistics> findByExample(
			HotInterestLabelStatistics instance) {
		...
		try {
			List<HotInterestLabelStatistics> results = (List<HotInterestLabelStatistics>) getSession()
					.createCriteria(
							"com.simplelife.renhai.server.db.HotInterestLabelStatistics")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding HotInterestLabelStatistics instance with property: "
	...
	public List<HotInterestLabelStatistics> findByGlobalInterestLabelId(
	...
	public HotInterestLabelStatistics merge(
			HotInterestLabelStatistics detachedInstance) {
