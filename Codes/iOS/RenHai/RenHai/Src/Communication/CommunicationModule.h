...
#define BASEURL_HTTP_SERVER @"http://192.81.135.31/renhaiproxy/"
...
#define NOTIFICATION_ID_PROXIMITYSTATEDIDCHANGE @"UIDeviceProximityStateDidChangeNotification"
#define NOTIFICATION_ID_FRONTCAMERAINVALID @"RHFrontCameraInvalid"
#define NOTIFICATION_ID_FRONTCAMERAVALID @"RHFrontCameraValid"
...
#define NOTIFICATION_ID_REMOTECOMMUNICATIONABNORMAL @"RHServerStatusAbnormal"
#define NOTIFICATION_ID_RHNETWORKPOOR @"RHNetworkPoor"
