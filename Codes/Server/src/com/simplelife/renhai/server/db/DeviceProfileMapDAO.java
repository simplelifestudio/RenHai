...
/**
 	* A data access object (DAO) providing persistence and search support for Deviceprofilemap entities.
...
public class DeviceProfileMapDAO extends BaseHibernateDAO  {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Deviceprofilemap instance with property: " + propertyName
            + ", value: " + value);
      try {
