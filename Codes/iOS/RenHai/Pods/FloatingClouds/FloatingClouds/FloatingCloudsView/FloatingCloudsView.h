...
typedef NS_ENUM(NSUInteger, FCFloatingType){
    FCFloatingTypeHorizontally = 0,
    FCFloatingTypeVertically,
    FCFloatingTypeRandom
};
...
@property (nonatomic, assign) FCFloatingType floatingType;              // Floating type of labels
