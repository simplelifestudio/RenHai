...
#define FLATUI_COLOR_MAJOR_B [UIColor colorWithHexCode:@"FF6060"] // 红
...
// CollectionCell
#define FLATUI_COLOR_COLLECTIONCELL_APP_BACKGROUND [UIColor colorWithHexCode:@"B0E2FF"]
#define FLATUI_COLOR_COLLECTIONCELL_APP_BACKGROUNDSELECTED FLATUI_COLOR_MAJOR_A
#define FLATUI_COLOR_COLLECTIONCELL_SERVER_BACKGROUND [UIColor colorWithHexCode:@"F09F9F"]
#define FLATUI_COLOR_COLLECTIONCELL_SERVER_BACKGROUNDSELECTED FLATUI_COLOR_MAJOR_B

// UIView
#define FLATUI_COLOR_UIVIEW_BACKGROUND FLATUI_COLOR_WHITE

// UICollectionReusableView
#define FLATUI_COLOR_UICOLLECTIONREUSABLEVIEW_BACKGROUND FLATUI_COLOR_WHITE
...
// View: LabelManager
#define FLATUI_COLOR_LABELMANAGER_BACKGROUND FLATUI_COLOR_WHITE
#define FLATUI_COLOR_LABELMANAGER_LABEL FLATUI_COLOR_WHITE
...
#define FLATUI_COLOR_LEFTBAR_CELL_BACKGROUND_SELECTING FLATUI_COLOR_COLLECTIONCELL_APP_BACKGROUND
...
// View: ChatVideo
#define FLATUI_COLOR_CHATMESSAGESENDER_BACKGROUND FLATUI_COLOR_WHITE
#define FLATUI_COLOR_CHATMESSAGE_BACKGROUND FLATUI_COLOR_WHITE

// View: UserIntroduction
#define FLATUI_COLOR_USERINTRODUCTION_PAGECONTROL FLATUI_COLOR_MAJOR_B
