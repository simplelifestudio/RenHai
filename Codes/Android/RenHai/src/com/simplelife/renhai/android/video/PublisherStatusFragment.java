...
import com.simplelife.renhai.android.video.PublisherControlFragment.PublisherCallbacks;
...
public class PublisherStatusFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_video_pub_status,
				container, false);
	...
	public void updateArchivingUI(boolean archivingOn) {
		...
		if (archivingOn) {
			statusText.setText(R.string.video_archivingOn);
