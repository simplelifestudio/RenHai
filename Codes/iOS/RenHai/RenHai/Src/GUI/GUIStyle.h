...
#define SECONDARY_COLOR_LIGHT [UIColor Grey81]
...
#define FLATUI_COLOR_NAVIGATIONBAR_CHATWIZARD [UIColor IndianRed2]
#define FLATUI_COLOR_TOOLBAR FLATUI_COLOR_NAVIGATIONBAR_CHATWIZARD
#define FLATUI_COLOR_TOOLBAR_BARBUTTONITEM FLATUI_COLOR_TOOLBAR
