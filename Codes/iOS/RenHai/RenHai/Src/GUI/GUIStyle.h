...
#define FLATUI_COLOR_BUTTONROALLBACK FLATUI_COLOR_MAJOR_B
...
#define FLATUI_COLOR_LEFTBAR_TEXT [UIColor grayColor]
#define FLATUI_COLOR_LEFTBAR_BACKGROUND [UIColor darkGrayColor]
#define FLATUI_COLOR_LEFTBAR_ROW_SELECTED FLATUI_COLOR_MAJOR_F
