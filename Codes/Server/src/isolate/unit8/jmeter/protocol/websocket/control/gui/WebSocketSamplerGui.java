...
public class WebSocketSamplerGui extends AbstractSamplerGui {
    ...
    private JTextField  behaviorMode;
    ...
    private JPanel getBehaviorTypePanel()
    {
        JLabel behaviorLabel = new JLabel(getResString("app_behavior_type"));
        behaviorMode = new JTextField(20);
        behaviorLabel.setLabelFor(behaviorMode);

        JPanel behaviorPanel = new JPanel(new BorderLayout(5, 0));
        behaviorPanel.add(behaviorLabel, BorderLayout.WEST);
        behaviorPanel.add(behaviorMode, BorderLayout.CENTER);
    ...
    private void init() {
        ...
        mainPanel.add(getBehaviorTypePanel());
