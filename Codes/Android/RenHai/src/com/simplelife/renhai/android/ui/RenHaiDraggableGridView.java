...
public class RenHaiDraggableGridView extends ViewGroup implements View.OnTouchListener, View.OnClickListener, View.OnLongClickListener {
    ...
    // listeners
    protected RenHaiDraggableGridViewListener onRearrangeListener;
    protected OnClickListener secondaryOnClickListener;
    private OnItemClickListener onItemClickListener;
    
    public RenHaiDraggableGridView (Context context, AttributeSet attrs) {
        super(context, attrs);
        setListeners();
    ...
    //OTHER METHODS
    public void setOnRearrangeListener(RenHaiDraggableGridViewListener l)
    {
