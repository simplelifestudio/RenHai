...
/**
 	* A data access object (DAO) providing persistence and search support for Globalinterestlabel entities.
...
public class GlobalinterestlabelDAO extends BaseHibernateDAO  {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Globalinterestlabel instance with property: " + propertyName
            + ", value: " + value);
      try {
