 ...
 * @author Jeff Gilfelt
 */
public class RenHaiBadgeView extends TextView {
	...
	public RenHaiBadgeView(Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}
	
	public RenHaiBadgeView(Context context, AttributeSet attrs) {
     ...
     */
	public RenHaiBadgeView(Context context, View target) {
     ...
     */
	public RenHaiBadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public RenHaiBadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public RenHaiBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
