...
/**
 	* A data access object (DAO) providing persistence and search support for Profileoperationlog entities.
...
public class ProfileoperationlogDAO extends BaseHibernateDAO  {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Profileoperationlog instance with property: " + propertyName
            + ", value: " + value);
      try {
